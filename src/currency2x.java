...
public class currency2x {
    public static void main (String args[]) throws IOException {
        ...
        List<String>valuta= new ArrayList<String>();  //Create 3 empty Array list, for each post in the data file.
        ...
        while(sc.hasNext()){
            ...
            valuta.add(sc2.next().toUpperCase());
            vardet.add(String.valueOf(sc2.next()));
            resten.add(sc2.nextLine().substring(1));
        }
        ...
        if (index_mot == -1){   // Are the currencies valid?
            ...
            System.out.println( "From " + resten.get(index_val) + " to "+" "+resten.get(index_mot)+".");
